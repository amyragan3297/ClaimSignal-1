...
### Behavior Prediction
- AI-powered adjuster behavior prediction based on historical patterns
- Predicts: negotiation style, response time, supplement likelihood
- Provides: likely actions, warning signals, success indicators, recommended approach
- Confidence level based on available data points
- API: POST `/api/predict-behavior` (requires adjusterId, optional claimId)