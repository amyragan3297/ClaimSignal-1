...
import { fetchClaim, fetchAdjusters, updateClaim, linkAdjusterToClaim } from "@/lib/api";
...
import { ArrowLeft, Calendar, Building2, MapPin, User, Phone, Mail, ClipboardList, Plus, CheckCircle2, XCircle, AlertCircle } from "lucide-react";
            ...
            <Card className="h-full">
              ...
              <CardContent>
                <ScrollArea className="h-[500px] pr-4">
                  {claim.interactions && claim.interactions.length > 0 ? (
                    <div className="relative">
                      <div className="absolute left-4 top-0 bottom-0 w-0.5 bg-border" />
                      <div className="space-y-4 pl-10">
                        {[...claim.interactions].reverse().map((interaction) => (
                          <div key={interaction.id} className="relative" data-testid={`interaction-${interaction.id}`}>
                    ...
                    <div className="text-center py-16 text-muted-foreground">
                      ...
                      <p className="text-sm">
                        Log interactions from an adjuster's profile and link them to this claim.
                      </p>
                    </div>
                  )}
                </ScrollArea>
